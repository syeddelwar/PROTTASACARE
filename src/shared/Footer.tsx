          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <Link href="/" className="flex flex-col justify-center">
                <h2 className=" text-xl text-white font-bold">Prottasa</h2>
            ...
            <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div>
                <p className="font-semibold text-gray-100">Helpful Links</p>
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-100">
                  <Link className="hover:opacity-75" href="/">
                    {" "}
                    Contact{" "}
              ...
              <div>
                <p className="font-semibold text-gray-100">Legal</p>
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-100">
                  <Link className="hover:opacity-75" href="/">
                    {" "}
                    Privacy Policy{" "}
